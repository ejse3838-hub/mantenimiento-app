...
if not st.session_state.auth:
    ...
    if menu == "🏠 Inicio":
        ...
        if not df.empty:
            ...
            st.plotly_chart(px.pie(df, names='estado', hole=0.4, title="Estado de la Planta"), use_container_width=True)
    ...
    # --- 2. PERSONAL (9 CAMPOS) ---
        ...
        with st.form("f_p"):
            ...
            cl1, dir_p = c1.selectbox("Clasificación 1", ["Interno", "Externo"]), c2.text_input("Dirección")
