...
if not st.session_state.auth:
    ...
    if menu == "🏠 Inicio":
        ...
        if not df.empty:
            ...
            fig2 = px.bar(df, x='prioridad', title="Carga por Prioridad")
    ...
    # --- 3. MAQUINARIA (12 CAMPOS RECUPERADOS) ---
    ...
    # --- 4. ÓRDENES (15 CAMPOS SINCRONIZADOS) ---
        ...
        with st.expander("➕ Lanzar Nueva OP"):
            with st.form("f_op"):
                ...
                tt, fr, dur = c4.selectbox("Tipo", ["Correctiva", "Preventiva"]), c5.selectbox("Frecuencia", ["Mensual", "Única"]), c6.text_input("Duración", "1h")
        ...
        if not df_o.empty:
            for _, row in df_o.iterrows():
                with st.container(border=True):
                    ...
                    # Firma integrada según tu diseño
